...
if __name__ == '__main__':
    ...
    vqgan = ARCH_REGISTRY.get('VideoCodeFormerStage2p5V2')(dim_embd=512, n_head=8, n_layers=9,
                codebook_size=1024, latent_size=256, st_latent_size=2048,
                connect_list=['32', '64', '128', '256'],
                fix_modules=['quantize','generator'], vqgan_path=None,motion_bank_size=16384).to(device)
